...
pub type GsrPictureCellBox = gtk::Box;

pub fn make_picture_cell_box(col: i32, row: i32, controller_rc: &RcController) -> GsrPictureCellBox {
    let gsr_picture_cell_box = gtk::Box::builder()
        ...
        .vexpand(true)
        .build();
    gsr_picture_cell_box.add_controller(make_gesture_click(1, col, row, controller_rc));
    gsr_picture_cell_box.add_controller(make_gesture_click(3, col, row, controller_rc));
