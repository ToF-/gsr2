...
impl TreeListWindow {
    pub fn new(
        ...
        let list_view = build_list_view(catalog.root_category());
        ...
        Self::attach_key_pressed_event_handler(&scrolled_window);
    ...
    fn attach_key_pressed_event_handler(window: &gtk::ScrolledWindow) {
        ...
        event_controller_key.connect_key_pressed(clone!(
            move |_, _key, _key_code, _modifier_type| Propagation::Stop
        ));
